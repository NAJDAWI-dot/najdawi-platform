...
export class MailService {
  ...
  async sendNudgeEmail(to: string, firstName: string, courseTitle: string, progress: number) {
    const subject = `🚀 We miss you, ${firstName}! Keep your momentum going.`;
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${this.frontendUrl}/student/dashboard" class="btn">Jump Back In</a>
        </div>
        <div class="footer">
  ...
  async sendWelcomeEmail(to: string, firstName: string) {
    const subject = `✨ Welcome to the Najdawi Platform, ${firstName}!`;
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${this.frontendUrl}/courses" class="btn">Explore Courses</a>
        </div>
        <div class="footer">
          &copy; ${new Date().getFullYear()} Najdawi Platform. All rights reserved.<br>
